...
import { Background, ButtonLink, Container, Dropdown, Feature, FeatureCallOut, Group, Logo, Link, Picture, PlayButton, Profile, Search, SearchIcon, SearchInput, Text } from './styles/header';
